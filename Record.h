...
void print_menu3();
void set_(float &, float &);
float to_percentage (float );
void print_graph (map <float,string> &,float &,float &,string);
void Show___ByType(vector <Record> &,map <string,int> &,float &,float &);
void Show___ByMethod(vector <Record> &,map <string,int> &,float &,float &);
...
void Show___ByMonth(vector <Record> &);
void Show___ByDate(vector <Record> &);
